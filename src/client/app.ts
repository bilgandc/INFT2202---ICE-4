...
import {createContact, deleteContact, fetchContact, fetchContacts} from "./api/contacts/index.js";
...
import {
    ...
    DisplayWeather,
    handleEditClick,
    handleCancelClick, getFormStorage, validateForm, removeFormStorage
} from "./utils"
import getFreshSideObject from "@popperjs/core/lib/utils/getFreshSideObject";
...
(function(){
    ...
    async function DisplayEditPage():Promise<void> {
        ...
        const page: string = hashPaths.length > 2? hashPaths[2]: "add";
